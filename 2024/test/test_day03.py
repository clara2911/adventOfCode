...
def test_part1_example_sum_of_multiplications_matches_puzzle_description():
    sum_multiplications = day03.get_solution_part1(input_path=Path("../input/day03/test_input_part1.txt"))
    assert sum_multiplications == 161


def test_part2_example_sum_of_multiplications_matches_puzzle_description():
    sum_multiplications = day03.get_solution_part2(input_path=Path("../input/day03/test_input_part2.txt"))
    assert sum_multiplications == 48


def test_regex_first_number():
...
def test_regex_second_number_and_do_or_dont():
